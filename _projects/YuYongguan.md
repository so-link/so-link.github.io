...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        ...
        <div style="margin-bottom: 30px;">
            ...
            <p style="margin: 8px 0;"><strong>本科院校：</strong>华南理工大学计算机科学与工程学院</p>
        </div>
        <!-- 联系信息 -->
        <div style="margin-bottom: 30px;">
            <h4 style="color: #1a6fc4; margin-bottom: 10px;">联系方式</h4>
            <p style="margin: 8px 0;"><strong>电子邮箱：</strong>csyyg_scut@mail.scut.edu.cn、1324603194@qq.com</p>
        </div>
        <!-- 研究方向 -->
        <div style="margin-bottom: 30px;">
            <h4 style="color: #1a6fc4; margin-bottom: 10px;">研究方向</h4>
                <p style="margin: 5px 0;">NLP、开放域关系抽取、多模态agent</p>
        </div>
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/yyg.jpg" title="个人图片" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
