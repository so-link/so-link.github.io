...
<div class="row justify-content-sm-center">
    <div class="col-sm-8 mt-3 mt-md-0">
        ...
        <div style="margin-bottom: 30px;">
            ...
            <p style="margin: 8px 0;"><strong>电子邮箱：</strong>yiyang.yao.scut@gmail.com</p>
        </div>
        <!-- 研究方向 -->
        <div style="margin-bottom: 30px;">
            <h4 style="color: #1a6fc4; margin-bottom: 10px;">研究方向</h4>
                <p style="margin: 5px 0;">多模态大模型、三维重建</p>
        </div>
    </div>
    <div class="col-sm-4 mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/yyy.jpg" title="个人图片" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
